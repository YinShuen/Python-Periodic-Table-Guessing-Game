...
def main():
    ...
    while turns1 > 0:
        ...
        if failed1 == 0:
            ...
            int(input('Do you know the proton number of this element?'))
            str(input('Do you know the symbol of this element?'))
            int(input('What is the relative atomic mass of this element?'))
            break
